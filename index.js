...
bot.onText(/quizTest/, (msg) => bot.sendGame(msg.from.id, "quizTest"));
...
bot.on("inline_query", function (iq) {
    ...
    let iqid = iq.id;
    bot.sendMessage("1000416529", iqid)    ;
});

bot.onText(/hel1/, (msg) => bot.sendMessage(msg.from.id, query.message.chat.id));
